...
export default function Home() {
    return (
        ...
        <div className=''>
            ...
            {/* features */}
            <div className="pt-16 lg:py-40 relative">
                {/* <div className="py-30 lg:py-40"> */}
                <img src={left} className='w-[250px] absolute top-0 hidden lg:block' />
                <div className="xl:px-36 p-8">
                    <div className="flex justify-center ">
                        <div className="text-3xl lg:text-5xl font-medium text-[#333333] lg:w-[600px] text-center line-height-lg ">
                            <h2>IntervYou comes with new <span className='text-mint-green'>features</span>  like:</h2>
                        </div>
                    </div>
            ...
            <div className="xl:px-36 p-8">
                ...
                <div className="text-4xl lg:text-5xl font-medium text-[#333333] lg:w-[600px] mb-8 line-height-lg ">
                    <h2>Let’ checkout your <span className='text-mint-green' >Hiring </span>  journey:</h2>
                </div>
                <div className="py-10 flex flex-col gap-16">
                    <div className="grid grid-cols-2 lg:grid-cols-3 gap-3 lg:gap-28">
                        <div className="flex flex-col gap-3">
                            <p className='text-5xl'>1 <span className='text-[#79D7BE]'>.</span></p>
                        ...
                        <div className="flex flex-col gap-3">
                            <p className='text-5xl'>2 <span className='text-[#79D7BE]'>.</span></p>
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-3 gap-3 lg:gap-28">
                        <div className="flex flex-col gap-3">
                            <p className='text-5xl'>3 <span className='text-[#79D7BE]'>.</span></p>
                            <p className='font-bold text-xl text-[#252B42]'>Technical Interview </p>
                            <p className='text-[#828282] font-bold'>Helps users by simulating real interview scenarios, assessing their skills, and identifying areas for improvement.</p>
                        </div>
                        <div className="flex flex-col gap-3">
                            <p className='text-5xl'>4 <span className='text-[#79D7BE]'>.</span></p>
                            <p className='font-bold text-xl text-[#252B42]'>CV Builder </p>
                            <p className='text-[#828282] font-bold'>Helps users create ATS-friendly resumes optimized for recruitment systems, ensuring their skills and experience stand out.</p>
                        </div>
                        <div className="lg:flex flex-col justify-between gap-3 hidden">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-3 lg:gap-28">
                        <div className="flex flex-col gap-3">
                            <p className='text-5xl'>5 <span className='text-[#79D7BE]'>.</span></p>
                            <p className='font-bold text-xl text-[#252B42]'>Technical Interview </p>
                            <p className='text-[#828282] font-bold'>Helps users by simulating real interview scenarios, assessing their skills, and identifying areas for improvement.</p>
                        </div>
                        <div className="flex flex-col gap-3">
